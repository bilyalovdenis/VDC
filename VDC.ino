...
#define GPS_TX 10                                          // 9.TX GPS
#define GPS_RX 11                                          // 10.RX GPS
                                                           //
//////Аналог.
...
void sendToWIFI(char sensorName, char number, float value) {             // Принимает название датчика, его порядковый номер и значение
